...
public class Player implements Serializable
{
	...
	// sets the player bank to -1. -1 is unreachable and they are removed from the game
	public void removeFromGame() {
		bank = -1;
	}
	
	// resets the bank to 0. Currently used to reset a removed player's bank from -1 to 0.
