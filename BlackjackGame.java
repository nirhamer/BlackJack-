...
public class BlackjackGame {
	...
	// receives the user commands to hit or stand
	public void hitOrStand() {
		...
		for (int i = 0; i < users; i++) {
			if ( players[i].getBet() > 0 ) {
				...
				do {
					do {
						System.out.print(players[i].getName() + " (H)it or (S)stand? ");
						command = ki.next();
	...
	// this section calculates all possible outcomes and adds or removes the players bets
	...
	// prints the players banks and tells the player if s/he is out of the game
	...
	// This part of the code resets all hands
	...
	// decides to force the game to end when all players lose all their money or lets players choose to keep playing or not
	...
	// says true or false to forcing the game to end
